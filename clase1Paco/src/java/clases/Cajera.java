...
public class Cajera implements Runnable {
    ...
    public final void initTiemposCajera() {
        ...
        tiempoPedidos.put(2, 5);//tiempo en procesar el producto 2
        tiempoPedidos.put(3, 7);//tiempo en procesar el producto 3
        tiempoPedidos.put(4, 10);//tiempo en procesar el producto 4
    }

    public Cajera(List<Pedido> pedidos, String nombre) {
        this.nombre = nombre;
        initTiemposCajera();
    ...
    public void run() {
        ...
        for (Pedido pActual : pedidos) {
            try {
                ...
                System.out.println("El pedido de " + nombre + " se ejecutó en: " + (System.currentTimeMillis() - tInicial)
